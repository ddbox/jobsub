...
class TaskServerRPM(TaskTar):
    ...
    def __init__(self, rel):
        ...
        _jobsub_api_conf_infile = "%s/jobsub-%s/server/conf/jobsub_api.conf"%(edit_dir,self.release.serverRPMVersion)
        self.updateFileList.append(_rpm_specs_infile)
        self.updateFileList.append(_jobsub_api_conf_infile)
    #   __init__
